...
let adimateExc = ref(false);
let betweenDays = ref(0)
const year = new Date().getFullYear()

const animationDelay = () => {
  document.querySelectorAll('.title-singl').forEach((span: any, index) => {
...
const linkUrlTranslate = () => {
  router.push({ name: "urlTranslate" })
}

const linkUrlTranslateQrcode = () => {
...
onMounted(() => {
  ...
  betweenDays.value = dayjs(newYear).diff(today, 'day');
})
</script>
...
<template>
  <section class="page-module">
    <div class="module-content">
      ...
      <div class="row">
        <div class="col-3 col-m-3 menu">
          ...
          <ul class="link-content block-item item-margin">
            ...
            <li @click="linkUrlTranslateQrcode">URL 转二维码</li>
            <li>其他功能-开发中</li>
          </ul>
        </div>
      ...
      <div class="footer">
        <p>© 2016-{{ year }} coderw.cn 版权所有 &nbsp;<a class="link"
            href="https://beian.miit.gov.cn/#/Integrated/index">辽ICP备16009639号</a></p>
      </div>
